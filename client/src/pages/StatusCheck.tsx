...
import { Search, Loader2, FileText, Calendar, Activity } from "lucide-react";
        ...
        <Card className="overflow-hidden shadow-lg animate-in slide-in-from-bottom-4 duration-500 border-t-4 border-t-primary">
          ...
          <div className="p-6 space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-900 font-semibold">
                  {format(new Date(data.createdAt), "dd 'de' MMMM 'de' yyyy 'às' HH:mm", { locale: ptBR })}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="text-sm font-medium text-slate-500">Tipo de Manifesto</p>
                <p className="text-slate-900 font-semibold capitalize">{data.type}</p>
              </div>
            </div>
